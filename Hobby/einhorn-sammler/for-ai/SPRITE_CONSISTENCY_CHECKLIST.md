...
Future agents must use this checklist before changing any sprite atlas in `Hobby/einhorn-sammler/assets/`.
...
- Each atlas width must be an exact multiple of the frame width used in `Hobby/einhorn-sammler/index.html`.
- Each atlas height must be an exact multiple of the frame height used in `Hobby/einhorn-sammler/index.html`.
...
- Create or update `Hobby/einhorn-sammler/for-ai/sprite-audit-log-YYYY-MM-DD.md` with per-asset results.
