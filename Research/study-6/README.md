# Study 6 Research Project

This folder groups the scientific study assets for Study 6: publication and
paper-writing materials, preregistration support, questionnaire materials,
browser-based VR questionnaire previews, participant-facing audio, and
AI/operator handoff notes.

- `index.html` is the browser-facing Study 6 landing page.
