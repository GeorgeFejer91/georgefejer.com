...
final class Study6NativeQuestionnairePanelController {
    ...
    private void renderDemographics(LinearLayout content) {
        ...
        addTextField(ageRow, uiText("demographics.age"), ageText, InputType.TYPE_CLASS_NUMBER, value -> ageText = value, 0.45f);
    ...
    private void logManualValidationFailure() {
        ...
        put(payload, "validation_summary", validationMessage());
        logger.logManualInteraction("manual_next_blocked_attempt", payload);
    }
    ...
    private EditText addTextField(LinearLayout parent, String label, String value, int inputType, TextChanged changed) {
        return addTextField(parent, label, value, inputType, changed, 1.0f);
    }

    private EditText addTextField(LinearLayout parent, String label, String value, int inputType, TextChanged changed, float weight) {
    ...
    private void addChoiceRow(LinearLayout parent, String label, String selected, Choice[] choices, ChoiceChanged changed) {
        TextView labelView = text(label, 15, COLOR_TEXT, true);
    ...
    private void addSamChoiceRow(LinearLayout parent, String dimension, String question, String low, String high, int selected, IntChanged changed) {
        ...
        for (int value = 1; value <= 9; value++) {
            ...
            choice.setOnClickListener(view -> changed.onChanged(choiceValue));
    ...
    private void addScaleChoice(LinearLayout parent, String question, String low, String high, int min, int max, int selected, IntChanged changed) {
        ...
        for (int value = min; value <= max; value++) {
            ...
            button.setOnClickListener(view -> changed.onChanged(option));
    ...
    private void addSlider(LinearLayout parent, String question, String low, String high, int value, IntChanged changed) {
