...
- Witch broomstick power-ups must render with `witch-broom-flight.png`, an original generated eight-frame broom-flight sprite matching the existing green witch identity, not only with a generic glow effect.
