...
Future agents must read this file before creating, regenerating, repairing, or integrating transformation sprite sheets for `einhorn-sammler/`.
...
- `for-ai/sprite-audit-log-YYYY-MM-DD.md` has been updated.
