...
- `asset-package/audio/` contains 8 final MP3 files.
- `asset-package/prompt_audio_raw/` contains 118 cached prompt MP3 files.
- `asset-package/transcripts/` contains 8 timed transcript files.
- `asset-package/source_transcripts_from_zip/` contains 8 source text files.
- `asset-package/validation_reports/` contains:
...
Required values in `asset-package/validation_reports/final_audio_duration_validation.csv`:
...
- `https://www.georgefejer.com/research-projects/`
- `https://www.georgefejer.com/research-projects/study6-neutral-hand-audio/`
- `https://www.georgefejer.com/research-projects/study6-neutral-hand-audio/wordings/EXACT_WORDING_LIBRARY.md`
- `https://www.georgefejer.com/research-projects/study6-neutral-hand-audio/asset-package/audio/study6_neutral_hand_audio_V01_EN.mp3`
